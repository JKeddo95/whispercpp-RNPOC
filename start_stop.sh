...
do
  ...
  ./stream -m models/ggml-large.bin -t 6 -tr -pc -f "/Users/jibreelkeddo/DailyLogs/Whispers/$TIMESTAMP_YEARMONTH/$FILENAME.txt" -fh "/Users/jibreelkeddo/DailyLogs/WhisperPages/$TIMESTAMP_YEARMONTH/$FILENAME.html" --step 57000 --length 57000 --keep 3000 &  # Run the script in the background
